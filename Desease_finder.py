...
data = df_pubmed('(intraocular lens) AND ((y_10[Filter]) AND (fha[Filter]) AND (clinicaltrial[Filter] OR meta-analysis[Filter] OR randomizedcontrolledtrial[Filter] OR review[Filter] OR systematicreview[Filter])) ')
text = ''
